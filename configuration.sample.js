...
export const TestnetVC = {
    ...
    url: 'https://beta-api.steemit.com',
    net: {
        addressPrefix: 'STX',
        chainId:
...
//should use the main net due to public testnet is not working...
export const Mainnet = {
    accounts: [],
    url: 'https://beta-api.steemit.com',
    accounts: [ 
        {
            address: 'name_of_your_app',
            privPosting: 'private_posting_key_your_own_discretion',
            privActive: '',
        }
    ],
    net: {
